...
const ABOUT_SILVIA_IMAGE_SRC = "/images/silvia-garcia-team.png";
const ALEX_IMAGE_SRC = "/images/alex-menendez.png";
const TEAM_ALEX_IMAGE_SRC = "/images/alex-menendez-team.png";
...
function ServiceCard({ title, text, button, onClick }) {
  return (
...
function BuyerExperienceShapeDivider() {
  return (
    <div className="relative overflow-hidden bg-white" aria-hidden="true">
      <svg className="block h-20 w-full md:h-28" viewBox="0 0 1440 140" preserveAspectRatio="none">
        <path
          d="M0 58C176 100 342 108 516 67C706 22 872 25 1064 73C1214 110 1345 100 1440 62V140H0V58Z"
          fill="rgba(123,128,112,0.10)"
        />
        <path
          d="M0 58C176 100 342 108 516 67C706 22 872 25 1064 73C1214 110 1345 100 1440 62"
          fill="none"
          stroke={BRAND_GOLD}
          strokeWidth="3"
          opacity="0.85"
    ...
    <>
      ...
      <section className="bg-[#fbfaf7] px-6 py-24">
        <div className="mx-auto grid max-w-7xl gap-16 lg:grid-cols-2">
          <div className="relative">
            <div className="absolute -left-5 -top-5 h-full w-full border" style={{ borderColor: gold }} />
            <div className="relative flex h-[640px] items-end justify-center overflow-hidden bg-white">
              <img src={ABOUT_SILVIA_IMAGE_SRC} className="h-full w-auto max-w-full object-contain object-bottom" alt="Silvia Garcia" />
            </div>
          </div>
          <div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            <div className="border border-neutral-200 bg-[#fbfaf7] p-8 shadow-sm">
              <div className="mb-7 aspect-square overflow-hidden border border-neutral-200 bg-[#e9e2d3]">
                <img src={ABOUT_SILVIA_IMAGE_SRC} className="h-full w-full object-cover object-center" alt="Silvia Garcia headshot" />
              </div>
            ...
            <div className="border border-neutral-200 bg-[#fbfaf7] p-8 shadow-sm">
              <div className="mb-7 aspect-square overflow-hidden border border-neutral-200 bg-[#e9e2d3]">
                <img src={TEAM_ALEX_IMAGE_SRC} className="h-full w-full object-cover object-center" alt="Alex Menendez headshot" />
              </div>
    ...
    <div className="grid gap-8 text-neutral-900 lg:grid-cols-2">
      <div className="border border-neutral-200 bg-white p-8 shadow-sm">
        <div className="flex items-center gap-5">
          <img src={ABOUT_SILVIA_IMAGE_SRC} className="h-24 w-24 rounded-full object-cover object-center" alt="Silvia Garcia headshot" />
        ...
        <div className="mt-8 space-y-5 text-neutral-700">
          ...
          <p className="flex items-center gap-3"><Mail size={18} style={{ color: gold }} /> Email: silvia@manendezrealtygroup.com</p>
          <p className="flex items-center gap-3"><Home size={18} style={{ color: gold }} /> Website: manendzrealtygroup.com</p>
        </div>
      </div>
      <div className="border border-neutral-200 bg-white p-8 shadow-sm">
        <div className="flex items-center gap-5">
          <img src={TEAM_ALEX_IMAGE_SRC} className="h-24 w-24 rounded-full bg-[#fbfaf7] object-cover object-center" alt="Alex Menendez headshot" />
        ...
        <div className="mt-8 space-y-5 text-neutral-700">
          ...
          <p className="flex items-center gap-3"><Mail size={18} style={{ color: gold }} /> Email: alex@manendezrealtygroup.com</p>
        </div>
      </div>
    </div>
  );
    ...
    <footer className="border-t border-white/10 px-6 py-10 text-white" style={{ backgroundColor: sage }}>
      <div className="mx-auto grid max-w-7xl gap-8 md:grid-cols-[1.2fr_1fr_1fr]">
        ...
        <div>
          ...
          <p className="text-sm text-white/70">silvia@manendezrealtygroup.com</p>
          <p className="mt-2 text-sm text-white/70">manendzrealtygroup.com</p>
